...
Tags: CDN, MAXCDN, jquery, js, optimisation, speed, WordPress Performance
...
It automatically detects the version of the script used by your theme and makes a request to it on the CDN CDN.
